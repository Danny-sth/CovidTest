public class Environment {
    ...
    public static final String createFilesEndpoint = "https://test-box-webshow.cmai.tech/api/v2/records/file";
    public static final String createRecordEndpoint = "https://test-box-webshow.cmai.tech/api/v2/records";
    public static final String getEndpoint = "https://test-box-webshow.cmai.tech/api/v2/records/";
